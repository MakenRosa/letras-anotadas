...
window.MUSICAS = [
...

  {
    ...
    estrofesEsperadas: 18,
    contexto:
      'É a música mais narrativa da apresentação: um assalto contado do começo ao fim, com nove ' +
      'personagens com nome e sem nenhum narrador organizando as coisas. Duas convenções ajudam a ' +
      'acompanhar. A primeira: a letra quase sempre dá a fala antes de dizer quem falou, então cada ' +
      'frase é atribuída no verso seguinte — quem apresentar precisa ler os pares juntos. A segunda: ' +
      'os dois lados recebem o mesmo tratamento, com os policiais também nomeados e com cadeia de ' +
      'comando própria. E a estrofe de abertura entrega o final antes de a ação começar, porque ela ' +
      'lista o que o dinheiro traz e inclui "falsos amigos" — é exatamente disso que a música vai ' +
      'tratar nas últimas quatro estrofes.',

    trechos: [
      {
        rotulo: 'Bendito dinheiro',
        estrofes: [0],
        notas: [
          { linhas: [0, 1], cor: 0, titulo: 'O que o dinheiro produz',
            texto: 'A lista é de coisas que vêm junto com dinheiro, e a última delas é "falsos amigos". Ele sabe que são falsos e mesmo assim os coloca na lista do que quer — a estrofe é a tese da música, e o desfecho vai cumpri-la ao pé da letra.' },
          { linhas: [2, 2], cor: 2, titulo: 'O pedido',
            texto: 'O verbo é "retornem": ele não quer conquistar aquilo, quer de volta. Antes de qualquer cena, a música já informa que houve um antes em que ele tinha essas coisas — e a justificativa apresentada é necessidade, não ambição.' }
        ]
      },

      {
        ...
        estrofes: [1],
        notas: [
          { linhas: [0, 1], cor: 0, titulo: 'A promessa',
            texto: 'A ordem vem junto com uma garantia: ninguém morre. É o tipo de coisa que se diz para manter reféns calmos, e a música vai desmenti-la duas estrofes depois.' },
          { linhas: [2, 2], cor: 2, titulo: '"Sou como você"',
            texto: 'Dito por quem está armado a quem está no chão. É a segunda frase da música a tentar tranquilizar, e ela funciona como argumento: ele se apresenta como igual, e não como inimigo, das pessoas que está assaltando.' }
        ]
      },

      {
        ...
        estrofes: [2],
        notas: [
          { linhas: [0, 1], cor: 0, titulo: 'Ainda é trabalho',
            texto: 'As duas primeiras ordens são de serviço: contar o dinheiro, guardar na mala, vestir as luvas. Até aqui o assalto está indo conforme o combinado, e o tom é de quem corrige um colega.' },
          { linhas: [2, 2], cor: 1, titulo: 'A virada acontece aqui',
            texto: 'No terceiro verso Jeffrey já está com um refém e uma arma apontada, e o companheiro manda largar os dois. O plano desandou entre uma linha e a outra, sem que a música conte o que houve no meio.' },
          { linhas: [3, 3], cor: 2, titulo: 'De colega a condenado',
            texto: 'A quarta linha não é mais ordem: é maldição. A estrofe inteira tem o mesmo nome no começo de cada verso e percorre, em quatro linhas, o caminho de parceiro a alguém que ele manda queimar no inferno.' }
        ]
      },

      {
        ...
        estrofes: [3],
        notas: [
          { linhas: [0, 1], cor: 0, titulo: 'A promessa dura duas estrofes',
            texto: 'Quem acionou o alarme é morto, e a letra informa isso na mesma frase em que informa o alarme. "Ninguém vai morrer" foi dito dois blocos atrás — a música não comenta a contradição, só a executa.' },
          { linhas: [2, 4], cor: 2, titulo: '"Acabar com a graça"',
            texto: 'O barulho traz as viaturas, e o problema apontado é que isso estraga a diversão. É a palavra que ele escolhe para o que estava acontecendo até ali, e ela diz mais sobre o narrador do que qualquer descrição.' }
        ]
      },

      {
        ...
        estrofes: [5],
        notas: [
          { linhas: [0, 2], cor: 0, titulo: 'O cerco',
            texto: 'A polícia chega e faz o pedido padrão: sair e se render. A resposta é um xingamento, e a música registra os dois lados da negociação em três versos.' },
          { linhas: [3, 3], cor: 1, titulo: 'Quem falou vem depois',
            texto: 'Só agora sabemos que a fala anterior era de Sid, e para quem ele falava. Esta é a convenção que a música usa até o fim: primeiro a frase, depois a etiqueta — e é o que exige atenção para não se perder entre os nomes.' },
          { linhas: [4, 5], cor: 1, titulo: 'O policial corrupto',
            texto: 'A ameaça vem de um agente que a própria narração apresenta como corrupto, antes de qualquer acusação dos assaltantes. A música toma esse partido por conta própria.' },
          { linhas: [6, 7], cor: 2, titulo: 'A única frase política',
            texto: 'A resposta de Sid é que, tendo chance, o policial estaria do lado deles. Ou seja: a diferença entre os dois grupos não seria de caráter, seria de oportunidade. É o argumento mais forte que a letra apresenta, e ela o coloca na boca de um assaltante cercado.' }
        ]
      },

      {
        ...
        estrofes: [6, 7],
        notas: [
          { linhas: [0, 2], cor: 0, titulo: 'O som no lugar da descrição',
            texto: 'A música não descreve o tiroteio: reproduz o barulho dele. A onomatopeia ocupa o lugar onde caberia a narração, e o que sobra de informação é só que ele correu.' },
          { linhas: [3, 5], cor: 2, titulo: 'A gramática se desmancha',
            texto: 'O verso mistura verbo conjugado e infinitivos na mesma frase — atira, correr, tentar. A construção quebrada imita alguém pensando em três coisas ao mesmo tempo, e a avaliação que vem depois é a mais simples possível: é uma merda.' }
        ]
      },

      {
        ...
        estrofes: [8],
        notas: [
          { linhas: [0, 1], cor: 0, titulo: 'Anthony acha a saída',
            texto: 'Ele anuncia ter encontrado por onde sair e morre no verso seguinte. A música junta a esperança e o fim dela no mesmo par de linhas, e é assim que ela vai tratar cada um dos três.' },
          { linhas: [2, 3], cor: 1, titulo: 'Patrick se rende',
            texto: 'Ele diz que se entrega e que não quer morrer ali, e morre ali mesmo. É o mais duro dos três pares: render-se não salvou, e a letra não comenta — só passa para o próximo.' },
          { linhas: [4, 5], cor: 2, titulo: 'Jimmy quer sair',
            texto: 'A fala dele é a única prática: sair antes que a polícia feche a saída. E o verbo usado para ele, "partir", é o mesmo aplicado a Anthony — mas no caso de Anthony a letra especificou que era para outra vida. Jimmy volta a falar na estrofe seguinte, então aqui ele apenas saiu.' },
          { linhas: [6, 7], cor: 0, titulo: 'O refém',
            texto: 'A decisão de soltar o refém é tomada por conveniência: mais gente ali só atrapalha. Não há gesto de misericórdia em nenhum verso — a mesma pessoa que garantiu no início que ninguém morreria agora libera o refém por logística.' }
        ]
      },

      {
        ...
        estrofes: [9],
        notas: [
          { linhas: [0, 1], cor: 0, titulo: 'A euforia no pior momento',
            texto: 'Três companheiros acabaram de cair e a frase é que agora eles são reis. Em seguida entra o telefonema para o Vito, que é a primeira vez que a música menciona alguém acima deles.' },
          { linhas: [2, 3], cor: 2, titulo: '"Eu sou Sid"',
            texto: 'Ele fecha a estrofe dizendo o próprio nome, como quem se anuncia. É o único personagem da música que faz isso, e é também o que vai dar a última fala da letra.' }
        ]
      },

      {
        ...
        estrofes: [10],
        notas: [
          { linhas: [0, 3], cor: 0, titulo: 'A técnica é real',
            texto: 'Correr em ziguezague é o procedimento de quem foge de tiro, para não oferecer trajetória previsível. A estrofe inteira é a instrução repetida, sem nenhuma outra informação.' },
          { linhas: [4, 7], cor: 2, titulo: 'O que a repetição faz',
            texto: 'O bloco vem quatro vezes seguidas e é o único trecho da música sem nome próprio, sem fala e sem narração. Enquanto ele dura, não há enredo: há só a corrida.' }
        ]
      },

      {
        ...
        estrofes: [11, 12],
        notas: [
          { linhas: [0, 3], cor: 0, titulo: 'A polícia pede autorização',
            texto: 'A cena muda de lado e o que se ouve é alguém pedindo permissão para atirar. Há hierarquia, pedido e espera — a música dá aos policiais um procedimento que os assaltantes, do outro lado, não têm.' },
          { linhas: [4, 5], cor: 1, titulo: 'Quem estava falando',
            texto: 'Só agora sabemos que era um policial num helicóptero, atirando de cima. A letra repete a convenção de identificar depois, e desta vez a informação atrasada é a mais importante da cena: a posição de quem atira.' },
          { linhas: [6, 7], cor: 2, titulo: 'O comandante autoriza',
            texto: 'A ordem é dada com nome e cargo, e no mesmo vocabulário grosseiro usado pelos assaltantes. Os dois lados da música falam igual.' }
        ]
      },

      {
        ...
        estrofes: [13],
        notas: [
          { linhas: [0, 1], cor: 0, titulo: 'A bala e o dinheiro',
            texto: 'O tiro acerta a roda, não uma pessoa, e o dinheiro vai para o ralo. A expressão é literal e figurada ao mesmo tempo: o dinheiro está indo embora fisicamente e no sentido em que se diz que dinheiro foi pelo ralo.' },
          { linhas: [2, 3], cor: 2, titulo: 'A queda',
            texto: 'O carro sai da ponte e cai na água. É o fim da fuga, e a música o descreve em dois versos secos, sem drama nenhum — o verso seguinte vai repetir só a última linha, como se a cena travasse ali.' }
        ]
      },

      {
        ...
        estrofes: [15, 16],
        notas: [
          { linhas: [0, 1], cor: 0, titulo: 'De quem é a culpa',
            texto: 'Caindo para a morte, o que ele faz é atribuir a responsabilidade — e ela não é da polícia nem do plano: é de quem encomendou o serviço e não estava lá.' },
          { linhas: [2, 3], cor: 1, titulo: 'O insulto',
            texto: 'A imagem é de alguém que só enxerga a si mesmo, dita da forma mais grosseira possível. E o pronome muda para "teu": ele para de falar sobre o Vito e passa a falar com ele, mesmo sem telefone na mão.' },
          { linhas: [4, 5], cor: 2, titulo: 'A ligação',
            texto: 'O chefe aparece na música apenas por telefone, e a primeira coisa que diz é cobrar atraso. Ele nunca esteve no banco, na fuga nem no carro.' },
          { linhas: [6, 7], cor: 0, titulo: 'A resposta dele',
            texto: 'Avisado de que vários morreram, ele mantém a cobrança. É a confirmação do que a primeira estrofe da música tinha listado: os amigos que o dinheiro traz são falsos, e este é o que estava no comando.' }
        ]
      },

      {
        rotulo: 'Morra sozinho',
        estrofes: [17],
        notas: [
          { linhas: [0, 1], cor: 0, titulo: 'O que o chefe chama de lixo',
            texto: 'A segunda ligação troca a cobrança pelo xingamento, e a palavra escolhida trata os empregados como descartáveis. É a única caracterização que o Vito recebe na música inteira, e ele mesmo a fornece.' },
          { linhas: [2, 3], cor: 2, titulo: 'A última fala',
            texto: 'Sid repete a ofensa como pergunta e responde mandando o chefe morrer sozinho. A música não termina em dinheiro, fuga nem prisão: termina com quem está afundando cortando quem ficou em terra — e "sozinho" é a palavra que fecha a história.' }
        ]
      }
    ]
  },
